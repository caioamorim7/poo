...
<figure class="w-full flex flex-col items-center justify-center text-center mt-4" v-click>
  ...
  <figcaption class="mt-4 text-sm text-center text-gray-600">
    Fonte: <a href="https://saileshdhakal.com.np/posts/oops-concept"
              target="_blank" 
              class="underline text-blue-600">
              https://saileshdhakal.com.np/posts/oops-concept
            </a>
  </figcaption>
</figure>
...
<figure class="w-full flex flex-col items-center justify-center text-center mt-4" v-click>
  ...
  />
  <figcaption class="mt-4 text-sm text-center text-gray-600">
    Fonte: <a href="https://www.linkedin.com/pulse/se-voc%C3%AA-n%C3%A3o-sabe-para-onde-ir-qualquer-caminho-serve-pablo-berriel/"
              target="_blank" 
              class="underline text-blue-600">
              https://www.linkedin.com/pulse/se-voc%C3%AA-n%C3%A3o-sabe-para-onde-ir-qualquer-caminho-serve-pablo-berriel/
          </a>
  </figcaption>
</figure>
...
A disciplina adota a linguagem de programação **Java**
  ...
  />
  <figcaption class="mt-4 text-sm text-center text-gray-600">
    Fonte: <a href="https://www.tiobe.com/tiobe-index/"
              target="_blank" 
              class="underline text-blue-600">
...
A disciplina adota a linguagem de programação **Java**
  ...
  />
  <figcaption class="mt-4 text-sm text-center text-gray-600">
    Fonte: <a href="https://1drv.ms/x/c/187d9a0eb7d8e7f9/Efnn2LcOmn0ggBiTLwAAAAABYnkEvdSiCdc3X7JUZgqrpg?e=Ll4Gt6"
              target="_blank" 
              class="underline text-blue-600">
              https://1drv.ms/x/c/187d9a0eb7d8e7f9/Efnn2LcOmn0ggBiTLwAAAAABYnkEvdSiCdc3X7JUZgqrpg?e=Ll4Gt6
            </a>
  </figcaption>
</figure>
...
## E o que muda com a inteligência artificial?
  ...
  />
  <figcaption class="mt-4 text-sm text-center text-gray-600">
    Fonte: <a href="https://fortune.com/2024/10/30/googles-code-ai-sundar-pichai/"
              target="_blank" 
              class="underline text-blue-600">
...
<div class="grid grid-cols-2 gap-6 items-center mt-4">
    <div class="w-full flex flex-col items-center justify-center text-center mt-4">
      <Youtube id="uDL_6A6zB0w" width="100%" height="300px"/>
    </div>
    <div class="text-lg leading-relaxed">
      <p class="italic justify-center text-justify">
        <strong>Probably in 2025, we at Meta, as well as the other companies that are basically working on this, are going to have an AI that can effectively be a sort of mid-level engineer that you have at your company that can write code</strong>
        <br/>
        <span class="text-base">Mark Zuckerberg, 2025</span>
      </p>
    </div>
  </div>
  ...
  <div class="mt-4 text-sm text-center text-gray-600">
      Fonte: 
      <a 
        href="https://www.youtube.com/watch?v=uDL_6A6zB0w" 
        target="_blank" 
        class="underline text-blue-600">
        https://www.youtube.com/watch?v=uDL_6A6zB0w
      </a>
  </div>
...
<figure class="w-full flex flex-col items-center justify-center text-center mt-4">
  ...
  />
  <figcaption class="mt-4 text-sm text-center text-gray-600">
    Fonte: <a href="https://keeps.com.br/piramide-de-aprendizagem-de-william-glasser-conceito-e-estrutura/"
              target="_blank" 
              class="underline text-blue-600">
              https://keeps.com.br/piramide-de-aprendizagem-de-william-glasser-conceito-e-estrutura/
            </a>
  </figcaption>
</figure>
