<template>
  <div class="slidev-layout default w-full h-full relative bg-white text-gray-800">
    ...
    <!-- Rodapé -->
    <footer class="absolute bottom-0 left-0 right-0 h-10 px-6 py-1 flex justify-between items-center text-xs text-gray-400 border-t border-gray-200 bg-blue-900 z-10">
