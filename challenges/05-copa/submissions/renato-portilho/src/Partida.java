...
public class Partida {
    ...
    private void registrarResultado() {
        ...
        Time perdedor = time1 == vencedor ? time2 : time1;

        resultadosPorTime.computeIfAbsent(vencedor, k -> new ArrayList<>())
                         .add(perdedor.getNome() + " - Venceu");

        resultadosPorTime.computeIfAbsent(perdedor, k -> new ArrayList<>())
