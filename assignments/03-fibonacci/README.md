...
5. O **método `formatarSaida`** deve receber um valor `long` representando o número de Fibonacci calculado e `n` representando o **n-ésimo número da sequência de Fibonacci** e retornar uma `String` formatada para exibição.
