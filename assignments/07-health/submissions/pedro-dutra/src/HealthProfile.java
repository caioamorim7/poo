...
public class HealthProfile {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Data de nascimento: " + patient.getDayOfBirth() + "/" + patient.getMonthOfBirth() + "/" + patient.getYearOfBirth());
        ...
        System.out.println("Classificação do BMI: " + patient.getBMICategory());
